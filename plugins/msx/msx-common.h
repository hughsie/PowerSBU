...
typedef enum {
	...
	MSX_DEVICE_KEY_BATTERY_VOLTAGE_OFFSET_FOR_FANS,
	MSX_DEVICE_KEY_EEPROM_VERSION,
	MSX_DEVICE_KEY_PV_CHARGING_POWER,
	MSX_DEVICE_KEY_CHARGING_TO_FLOATING_MODE,
	MSX_DEVICE_KEY_SWITCH_ON,
	MSX_DEVICE_KEY_LAST
} MsxDeviceKey;
